...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupTabBarItem() -> Void {
        ...
        var selectAttrs = Dictionary<String, Any>()
        selectAttrs[NSFontAttributeName] = attrs[NSFontAttributeName]
        selectAttrs[NSForegroundColorAttributeName] = UIColor.darkGray
        
        UITabBarItem.appearance().setTitleTextAttributes(attrs, for: .normal)
        UITabBarItem.appearance().setTitleTextAttributes(selectAttrs, for: .selected)
    }
